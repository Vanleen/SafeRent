...
<main class="container">
    ...
    <br>
        <div class="bg-light p-5 rounded">
            <h1 class="pb-4 border-bottom">Connexion </h1>
            <p class="lead">Bienvenue sur votre espace de connexion. Veuillez entrer les informations pour commencer à naviguer.</p>
        ...
        <div class="row">
            <div class="col-sm-4 mt-5 mx-auto">
                <form method="post" action="" class="border p-3">
                    ...
                    <div class="mb-3">
                        <input type="submit" class="btn btn-outline-white text-white w-100" id="connexion" name="connexion" value="Connexion">
                    </div>
                </form>
            </div>
        </div>
