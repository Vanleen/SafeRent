...
<main class="container">
    <div class="p-5 rounded">
        <h1 class="pb-4 border-bottom">Statistiques</h1>
        <p class="lead">Bienvenue sur votre espace des statistiques, cher Administrateur.</p>
        <?php echo $msg . '<hr>'; // Message d'erreur utilisateur qui s'affiche en cas d'erreur sur le pseudo ou autre ?>
        <div>
            <img class="illustration" src="../assets/img/illustration8.png" alt="Une image de la gestion membre.">
        </div>
    </div>
            ...
            <div class="col-auto">
                ...
                <?php
                    ...
                    if ($selection == 'meilleures_notes' ) {
                        ...
                        for ($i = 0; $i <=4; $i++) {
                            echo '
                                <div>' . $note_moyenne[$i]['id_salle'] . ' - '. $note_moyenne[$i]['titre'] . ' -> ' . number_format($note_moyenne[$i]['note'],2) . ' /10<br><div>';
                        }
