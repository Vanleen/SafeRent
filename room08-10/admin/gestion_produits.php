...
//--------------------------------------------------------------------------
//--------------------------------------------------------------------------
// ENREGISTREMENT & MODIFICATION PRODUIT
//--------------------------------------------------------------------------
//--------------------------------------------------------------------------
$id_produit = '';
$date_arrivee = '';
...
//--------------------------------------------------------------------------
//--------------------------------------------------------------------------
// RECUPERATION DES INFOS DES PRODUITS A MODIFIER
//--------------------------------------------------------------------------
//--------------------------------------------------------------------------
...
<main class="container">
    ...
    <div class="p-5 rounded">
        <h1 class="pb-4 border-bottom">Gestion des produits</h1>
        <p class="lead">Cher Administrateur, bienvenue sur la gestion des produits.</p>
        <?php echo $msg . '<hr>'; // variable destinée à afficher des messages utilisateur  
        ?>
        <div>
            <img class="illustration" src="../assets/img/illustration1.png" alt="Une image de la gestion salle.">
        </div>
    </div>
    <div class="row">
            ...
            <table class="table table-bordered">
                ...
                <?php
                 while ($ligne = $liste_produit->fetch(PDO::FETCH_ASSOC)) {
                    ...
                    echo '<td class="text-center">' . $ligne['titre'] . '<br>' . '<img src="' . URL . 'assets/img-salles/' . $ligne['photo'] . '"class="img-thumbnail" width="70">' . '</td>';
                    echo '<td>' . $ligne['prix'] . ' €</td>';
                    echo '<td>' . $ligne['etat'] . '</td>';
                    echo '
                            <td class="text-center"><a href="?action=modifier&id_produit=' . $ligne['id_produit'] . '" class=" btn-warning text-white"><i class="fas fa-edit"></i></a></td>';
                    echo '<td class="text-center"><a href="?action=supprimer&id_produit=' . $ligne['id_produit'] . '" class=" btn-danger confirm_delete" ><i class="far fa-trash-alt"></i></a></td>';
                    echo '</tr>';
                }
                ?>
            </table>
